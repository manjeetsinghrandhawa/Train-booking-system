...
This project contains a backend API and a React frontend for booking train seats with strict seat allocation rules.

## Project Structure

- `backend/`: Express API with in-memory seat and booking data
...
3. Install root tooling dependency:
   - `npm install`
4. Install backend dependencies:
   - `npm install --prefix backend`
5. Install frontend dependencies:
   - `npm install --prefix frontend`
6. Start backend and frontend together from the root:
   - `npm run dev`
...
Reason: this matches available API design (`/bookings/:userId`).
